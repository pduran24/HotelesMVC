...
public class DataSeeder implements CommandLineRunner {
    ...
    private void crearHoteles() {
        List<Hotel> hoteles = List.of(
                // Orden de booleanos finales: (admiteMascotas, tieneSpa, incluyeDesayuno)

                // --- VALLE DE ARÁN (Lleida) ---
                buildHotel("Gran Hotel La Florida", "Baqueira Beret", "Lujo a pie de pistas en la cota 1500. Spa de aguas termales, gastronomía aranesa y servicio de guardaesquís exclusivo.", 5, "350.00", 42.6990, 0.9333, false, true, true),
                buildHotel("Parador de Vielha", "Vielha", "Vistas panorámicas al Valle de Arán. Spa circular acristalado y arquitectura típica de montaña. Ideal para desconectar.", 4, "180.50", 42.7051, 0.7963, false, true, true),
                buildHotel("Hotel Val de Neu", "Baqueira", "Elegancia y diseño moderno. Habitaciones con chimenea y vistas a la montaña. Servicio 5 estrellas Gran Lujo.", 5, "420.00", 42.7005, 0.9320, true, true, true),
                buildHotel("Refugio Rosta", "Salardú", "El hotel más antiguo del Valle. Ambiente rústico, madera crujiente y trato familiar. Historia viva del pirineismo.", 2, "60.00", 42.7072, 0.9023, true, false, true),
                buildHotel("Posada Real de Santa Maria", "Unha", "Pequeña posada con encanto en uno de los pueblos más bonitos. Trato muy personal.", 2, "65.00", 42.7093, 0.9035, false, false, true),
                buildHotel("Camping Verneda", "Pont d'Arròs", "Bungalows de madera en pleno bosque. Sonido del río Garona constante. Perfecto para verano.", 2, "55.00", 42.7335, 0.7652, true, false, false),

                // --- PIRINEO ARAGONÉS (Huesca) ---
                buildHotel("Gran Hotel Balneario de Panticosa", "Panticosa", "Edificio histórico del siglo XIX rodeado de picos de 3000m. Aguas medicinales y lujo clásico.", 4, "210.00", 42.7601, -0.2372, false, true, true),
                buildHotel("Balneario de Panticosa Continental", "Panticosa", "Diseño de Rafael Moneo. Modernidad integrada en la naturaleza. Circuito termal incluido.", 4, "150.00", 42.7598, -0.2365, false, true, true),
                buildHotel("Hotel Ciria", "Benasque", "Referente en el valle. Arquitectura en piedra y madera, famoso por su cocina de caza y setas. Ambiente de montañeros.", 3, "95.00", 42.6062, 0.5228, true, false, true),
                buildHotel("Hotel Sommos Aneto", "Benasque", "Diseño en madera, vistas al río Ésera. Tienda de material de montaña en el propio hotel.", 4, "140.00", 42.6055, 0.5236, false, true, true),
                buildHotel("Barceló Monasterio de Boltaña", "Boltaña", "Antiguo monasterio del siglo XVII reformado. Spa completo, aguas terapéuticas y piscina exterior enorme entre montañas.", 5, "190.00", 42.4431, 0.0652, true, true, true),
                buildHotel("Refugio de Góriz", "Parque Nacional Ordesa", "Solo accesible a pie (4h). A los pies del Monte Perdido. Literas, cena comunitaria y el cielo más estrellado.", 1, "25.00", 42.6635, 0.0412, false, false, true),
                buildHotel("Hotel Edelweiss", "Candanchú", "A 50 metros del telesilla. Ideal para familias y cursillos de esquí. Sencillo pero con todo lo necesario.", 3, "85.00", 42.7885, -0.5270, false, false, true),
                buildHotel("Hotel & Spa Real Badaguás", "Jaca", "Complejo moderno con campo de golf y spa. Vistas a la Peña Oroel. Perfecto para combinar deporte y relax.", 4, "115.00", 42.5852, -0.4895, true, true, true),
                buildHotel("Casa Rural El Callizo", "Aínsa", "En el corazón de la villa medieval. Muros de piedra, desayunos caseros y vistas a la Peña Montañesa.", 3, "75.00", 42.4165, 0.1382, true, false, true),
                buildHotel("Hotel La Casueña", "Lanuza", "A orillas del embalse. Vistas espectaculares a Foratata. Pequeño, íntimo y con un restaurante exquisito.", 3, "105.00", 42.7568, -0.3165, false, false, true),
                buildHotel("Albergue de Canfranc", "Canfranc-Estación", "Económico y funcional. Punto de encuentro de peregrinos del Camino de Santiago y esquiadores.", 1, "22.00", 42.7505, -0.5142, true, false, false),
                buildHotel("Hotel Tierra de Biescas", "Biescas", "Diseño nórdico en el Pirineo Aragonés. Jardines amplios y piscina climatizada todo el año.", 4, "130.00", 42.6285, -0.3228, true, true, true),
                buildHotel("Refugio de Cap de Llauset", "Montanuy", "El refugio más moderno del Pirineo. Arquitectura vanguardista a 2400m de altura.", 1, "30.00", 42.5892, 0.6975, false, false, true),

                // --- ANDORRA Y CATALUÑA (Cerdanya) ---
                buildHotel("Sport Hotel Hermitage & Spa", "Soldeu", "El único Leading Hotel of the World en Andorra. Acceso directo al Sport Wellness Mountain Spa.", 5, "550.00", 42.5765, 1.6645, false, true, true),
                buildHotel("Hotel Nordic", "El Tarter", "Hotel clásico a pie de pistas. Habitaciones de madera, bolera y piscina interior. Muy familiar.", 4, "160.00", 42.5798, 1.6502, false, true, true),
                buildHotel("Hotel Fontanals Golf", "Cerdanya", "Rodeado de naturaleza y campos de golf. Ambiente tranquilo, ideal para escapadas de primavera y otoño.", 4, "120.00", 42.4045, 1.9052, true, false, true),

                // --- PIRINEO NAVARRO ---
                buildHotel("Hotel Roncesvalles", "Roncesvalles", "Antiguo hospital de peregrinos reformado. Historia medieval y confort moderno. Inicio del Camino Francés.", 3, "70.00", 43.0092, -1.3195, true, false, true),
                buildHotel("Isaba Hotel", "Valle del Roncal", "Apartamentos turísticos ideales para esquí de fondo y senderismo por la Selva de Irati.", 3, "80.00", 42.8605, -0.9232, true, false, false)
        );
    ...
    private Hotel buildHotel(String nombre, String ubicacion, String descripcion, Integer estrellas,
                             ...
                             boolean admiteMascotas, boolean tieneSpa, boolean incluyeDesayuno) {
        Hotel hotel = new Hotel();
        hotel.setNombre(nombre);
        hotel.setUbicacion(ubicacion);
        hotel.setDescripcion(descripcion);
        hotel.setEstrellas(estrellas);
        hotel.setPrecioNoche(new java.math.BigDecimal(precioNoche));
        hotel.setLatitud(latitud);
        hotel.setLongitud(longitud);

        // --- NUEVOS CAMPOS ---
        hotel.setAdmiteMascotas(admiteMascotas);
        hotel.setTieneSpa(tieneSpa);
        hotel.setIncluyeDesayuno(incluyeDesayuno);
